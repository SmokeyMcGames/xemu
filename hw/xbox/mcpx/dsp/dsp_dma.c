...
void dsp_dma_write(DSPDMAState *s, DSPDMARegister reg, uint32_t v)
{
    ...
    case DMA_START_BLOCK:
        ...
        break;
    case DMA_NEXT_BLOCK:
        // fprintf(stderr, "DMA_NEXT_BLOCK set = %x\n", v);
        s->next_block = v;
        break;
    default:
        assert(false);
